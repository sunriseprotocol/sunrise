//! Sunrise-specific RPCs implementation.
...
pub use srs_pallet_evm_rpc::{EVMApi, EVMApiServer, EVMRuntimeRPCApi};
...
{
	use srs_pallet_staking_pool_rpc::{StakingPool, StakingPoolApi};
