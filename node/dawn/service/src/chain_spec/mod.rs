//! Sunrise chain configurations.

use sunrise_primitives::{AccountId, AccountPublic, Balance, Nonce, PREDEPLOY_ADDRESS_START};
...
pub struct Extensions {
	...
	pub fork_blocks: sc_client_api::ForkBlocks<sunrise_primitives::Block>,
	/// Known bad block hashes.
	pub bad_blocks: sc_client_api::BadBlocks<sunrise_primitives::Block>,
}
