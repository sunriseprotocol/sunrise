//! Sunrise Client abstractions.

use srs_primitives::{AccountId, Balance, Block, BlockNumber, CurrencyId, DataProviderId, Hash, Header, Nonce};
use srs_runtime_common::TimeStampedPrice;
...
pub trait RuntimeApiCollection:
	...
	+ srs_pallet_evm_rpc_runtime_api::EVMRuntimeRPCApi<Block, Balance>
...
///
/// As there exist multiple chains inside Sunrise, like Sunrise itself and Dawn
...
/// A handle to a Sunrise client instance.
///
/// The Sunrise service supports multiple different runtimes (Dawn, Sunrise 
...
/// A client instance of Sunrise.
#[derive(Clone)]
pub enum Client {
	#[cfg(feature = "with-dawn-runtime")]
	Dawn(Arc<crate::FullClient<dawn_runtime::RuntimeApi, crate::DawnExecutor>>),
	#[cfg(feature = "with-sunrise-runtime")]
	Sunrise(Arc<crate::FullClient<sunrise_runtime::RuntimeApi, crate::SunriseExecutor>>),
}
...
impl ClientHandle for Client {
	fn execute_with<T: ExecuteWithClient>(&self, t: T) -> T::Output {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => T::execute_with_client::<_, _, crate::FullBackend>(t, client.clone()),
		}
	}
}
...
impl sc_client_api::UsageProvider<Block> for Client {
	fn usage_info(&self) -> sc_client_api::ClientInfo<Block> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.usage_info(),
		}
	}
}
...
impl sc_client_api::BlockBackend<Block> for Client {
	fn block_body(&self, id: &BlockId<Block>) -> sp_blockchain::Result<Option<Vec<<Block as BlockT>::Extrinsic>>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.block_body(id),
		}
	}
	...
	fn block(&self, id: &BlockId<Block>) -> sp_blockchain::Result<Option<SignedBlock<Block>>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.block(id),
		}
	}
	...
	fn block_status(&self, id: &BlockId<Block>) -> sp_blockchain::Result<BlockStatus> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.block_status(id),
		}
	}
	...
	fn justification(&self, id: &BlockId<Block>) -> sp_blockchain::Result<Option<Justification>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.justification(id),
		}
	}
	...
	fn block_hash(&self, number: NumberFor<Block>) -> sp_blockchain::Result<Option<<Block as BlockT>::Hash>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.block_hash(number),
		}
	}
	...
	fn extrinsic(&self, id: &<Block as BlockT>::Hash) -> sp_blockchain::Result<Option<<Block as BlockT>::Extrinsic>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.extrinsic(id),
		}
	}
}
...
impl sc_client_api::StorageProvider<Block, crate::FullBackend> for Client {
	fn storage(&self, id: &BlockId<Block>, key: &StorageKey) -> sp_blockchain::Result<Option<StorageData>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.storage(id, key),
		}
	}
	...
	fn storage_keys(&self, id: &BlockId<Block>, key_prefix: &StorageKey) -> sp_blockchain::Result<Vec<StorageKey>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.storage_keys(id, key_prefix),
		}
	}
	...
	fn storage_hash(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.storage_hash(id, key),
		}
	}
	...
	fn storage_pairs(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.storage_pairs(id, key_prefix),
		}
	}
	...
	fn storage_keys_iter<'a>(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.storage_keys_iter(id, prefix, start_key),
		}
	}
	...
	fn child_storage(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.child_storage(id, child_info, key),
		}
	}
	...
	fn child_storage_keys(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.child_storage_keys(id, child_info, key_prefix),
		}
	}
	...
	fn child_storage_hash(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.child_storage_hash(id, child_info, key),
		}
	}
	...
	fn max_key_changes_range(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.max_key_changes_range(first, last),
		}
	}
	...
	fn key_changes(
		...
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.key_changes(first, last, storage_key, key),
		}
	}
}
...
impl sp_blockchain::HeaderBackend<Block> for Client {
	fn header(&self, id: BlockId<Block>) -> sp_blockchain::Result<Option<Header>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.header(&id),
		}
	}
	...
	fn info(&self) -> sp_blockchain::Info<Block> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.info(),
		}
	}
	...
	fn status(&self, id: BlockId<Block>) -> sp_blockchain::Result<sp_blockchain::BlockStatus> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.status(id),
		}
	}
	...
	fn number(&self, hash: Hash) -> sp_blockchain::Result<Option<BlockNumber>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.number(hash),
		}
	}
	...
	fn hash(&self, number: BlockNumber) -> sp_blockchain::Result<Option<Hash>> {
		match self {
			...
			#[cfg(feature = "with-sunrise-runtime")]
			Self::Sunrise(client) => client.hash(number),
		}
	}
}