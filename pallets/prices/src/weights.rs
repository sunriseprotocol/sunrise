...
/// Weights for module_prices using the Sunrise node and recommended hardware.
pub struct SunriseWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for SunriseWeight<T> {
	fn lock_price() -> Weight {
