...
//! Autogenerated weights for module_slip
//!
...
// --heap-pages=4096
// --output=./modules/slip/src/weights.rs
...
/// Weight functions needed for srs_pallet_slip.
...
/// Weights for srs_pallet_slip using the Acala node and recommended hardware.
