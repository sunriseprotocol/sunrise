//! Mocks for the shy treasury module.
...
parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = SRS;
}
...
parameter_types! {
	...
	pub EnabledTradingPairs : Vec<TradingPair> = vec![TradingPair::new(SUSD, BTC)];
...
parameter_types! {
	pub const SHYTreasuryModuleId: ModuleId = ModuleId(*b"aca/shyt");
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		SHYTreasuryModule: shy_treasury::{Module, Storage, Call, Config, Event<T>},
