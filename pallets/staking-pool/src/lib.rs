...
use srs_pallet_support::{
	ExchangeRate, SlipProtocol, NomineesProvider, OnNewEra, PolkadotBridge, PolkadotBridgeCall, PolkadotBridgeState,
...
pub mod module {
	...
	pub trait Config: frame_system::Config {
		...
		/// The staking currency id(should be DOT in sunrise)
		#[pallet::constant]
		type StakingCurrencyId: Get<CurrencyId>;

		/// The liquid currency id(should be LDOT in sunrise)
		#[pallet::constant]
...
impl<T: Config> SlipProtocol<T::AccountId, Balance, EraIndex> for Pallet<T> {
