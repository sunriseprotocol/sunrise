...
use crate::precompile::mock::{
	alice, bob, new_test_ext, run_to_block, Balances, Dexpallet, DexPrecompile, Oracle, OraclePrecompile, Origin,
...
fn dex_precompile_get_liquidity_should_work() {
	new_test_ext().execute_with(|| {
		// enable XBTC/AUSD
		assert_ok!(Dexpallet::enable_trading_pair(Origin::signed(ALICE), XBTC, AUSD,));
