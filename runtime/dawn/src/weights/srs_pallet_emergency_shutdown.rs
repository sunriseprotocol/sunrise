//! Autogenerated weights for srs_pallet_emergency_shutdown
//!
...
/// Weight functions for srs_pallet_emergency_shutdown.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> srs_pallet_emergency_shutdown::WeightInfo for WeightInfo<T> {
