//! Autogenerated weights for srs_pallet_shy_engine
//!
...
/// Weight functions for srs_pallet_shy_engine.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> srs_pallet_shy_engine::WeightInfo for WeightInfo<T> {
