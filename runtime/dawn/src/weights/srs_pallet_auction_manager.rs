//! Autogenerated weights for srs_pallet_auction_manager
//!
...
/// Weight functions for srs_pallet_auction_manager.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> srs_pallet_auction_manager::WeightInfo for WeightInfo<T> {
